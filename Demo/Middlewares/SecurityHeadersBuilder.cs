...
namespace SilverSoft.Middlewares
{
    ...
    public class SecurityHeadersBuilder
    {
        ...
        public SecurityHeadersBuilder AddDefaultSecurePolicy()
        {
            ...
            //AddDefaultContentSecurityPolicy();
            AddDefaultContentSecurityPolicyReportOnly();
            RemoveServerHeader();

            return this;
        }

        public SecurityHeadersBuilder AddDefaultContentSecurityPolicy()
        {
            _policy.SetHeaders["Content-Security-Policy"] = "object-src 'self'; form-action 'self'; frame-ancestors 'self'";
            return this;
        }

        public SecurityHeadersBuilder AddDefaultContentSecurityPolicyReportOnly()
        {
            _policy.SetHeaders["Content-Security-Policy-Report-Only"] = "object-src 'self'; form-action 'self'; frame-ancestors 'self'; report-uri /cspreport";
            return this;
        }
